    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="HCI">
                <input type="text" name="p2" id="" placeholder="BC">
                <input type="text" name="p3" id="" placeholder="TOC">
                <input type="text" name="p4" id="" placeholder="DB">
                <input type="text" name="p5" id="" placeholder="SE">
